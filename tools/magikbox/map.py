...
from magikbox.sonic_discovery import VECTOR_SCHEMA, _parse_vector_literal
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate a simple 2D map from Magikbox vectors")
    parser.add_argument("--out-dir", type=Path, default=Path("artifacts/magikbox_map"), help="Output directory")
    return parser
