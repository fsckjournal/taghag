...
import magikbox.crates as crates
import magikbox.human_correction as human_correction
import magikbox.map as magikbox_map
import magikbox.sonic_discovery as sonic_discovery
import magikbox.sync_vibes as sync_vibes
import pytest
...
def test_generate_map_writes_json_and_csv(tmp_path: Path, monkeypatch) -> None:
    ...
    json_out, csv_out = magikbox_map.generate_map(tmp_path)
