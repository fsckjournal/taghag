...
from magikbox.sonic_discovery import SonicDiscoveryIndex
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate a neighborhood crate playlist from Magikbox vectors")
